...
* [Dependency Manager](../../libs/dependency_manager/README.html) - This library can be used to add service dependency is a declarative way.  A locking or syncing mechanism can be selected to safely use services. Note that this is not part of the OSGi standard.
...
C++ support is added with the use of a [C++ Dependency Manager](../../libs/dependency_manager_cxx/README.html).
