...
See the [C Dependency Manager](../../libs/dependency_manager/README.html) and [C Dependency Manager example](../../examples/celix-examples/dm_example) for more information and a more complex working example.
